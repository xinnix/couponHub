  ...
  <view class="confirm-page">
    ...
    <view class="top-bar">
      <view class="top-bar-content">
        ...
        <text class="page-title">核销确认</text>
    ...
    <view class="main-content">
      ...
      <view class="coupon-card">
        ...
        <view class="coupon-value-section">
          <text class="coupon-value">¥{{ faceValue }}</text>
        ...
        <view class="coupon-details">
          ...
          <text class="coupon-title">{{ couponTitle }}</text>
          <view class="coupon-tags">
            <text class="coupon-tag">{{ couponType }}</text>
        ...
        <!-- 打孔效果 -->
        <view class="punch-hole punch-hole-left"></view>
        <view class="punch-hole punch-hole-right"></view>
      </view>

      <!-- 验证信息 -->
      <view class="validation-section">
        <view class="validation-item">
          <text class="validation-label">券码</text>
          <text class="validation-value code-text">{{ displayCode }}</text>
        </view>
        <view class="validation-divider"></view>
        <view class="validation-item">
          <text class="validation-label">状态</text>
    ...
    <view class="action-area">
      <button class="confirm-btn" @click="handleConfirm" :disabled="confirming">
        <text class="confirm-icon">✓</text>
        <text class="confirm-text">{{ confirming ? '核销中...' : '确认核销' }}</text>
      </button>
    </view>
  </view>
</template>
